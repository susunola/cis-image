...
__all__ = [
    ...
    '_probe_public_ip', '_probe_scan', '_probe_setup_keypair', '_probe_ssh_ready', '_probe_ssh_ready_any',
    '_probe_teardown_keypair', '_probe_terminate', '_probe_vnc_url', '_record_lineage', '_reports_dir',
